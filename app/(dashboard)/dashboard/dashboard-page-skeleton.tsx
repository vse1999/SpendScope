...
export function DashboardHeroSkeleton(): React.JSX.Element {
  return (
    <>
      ...
      <div className="grid items-start gap-5 md:grid-cols-3">
        {Array.from({ length: 3 }).map((_, index) => (
          <Card key={`dashboard-stats-skeleton-${index}`} className="app-card-strong min-h-56">
...
export function DashboardRecentExpensesSkeleton(): React.JSX.Element {
  return (
...
export function DashboardCategoryBreakdownSkeleton(): React.JSX.Element {
  return (
...
export function DashboardQuickStatsSkeleton(): React.JSX.Element {
  return (
    <Card className="app-card">
      <CardHeader>
