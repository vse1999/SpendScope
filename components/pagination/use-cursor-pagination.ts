...
/**
 * Hook for managing pagination URL state (useful for SSR)
 */
export interface UsePaginationUrlStateReturn {
  cursor: string | null;
  direction: CursorDirection;
  limit: number;
}
 ...
 * @param searchParams - URLSearchParams or Record of params
 * @returns Parsed pagination state
 */
export function parsePaginationParams(
  searchParams: URLSearchParams | Record<string, string | string[] | undefined>,
): UsePaginationUrlStateReturn {
  ...
  const direction = params.get("direction") as CursorDirection | null;
...
/**
 * Builds URL search params for pagination navigation
 */
export function buildPaginationUrlParams(
  cursor: string | null,
  direction: CursorDirection,
  limit: number,
): string {
