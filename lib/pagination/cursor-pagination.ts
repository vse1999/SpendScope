 ...
 * @param sortField - The field to sort by (default: createdAt)
 * @param sortDirection - The sort direction (default: desc)
...
export function buildPrismaOrderBy(
  ...
  const dbField = fieldMapping[sortField] || "createdAt";
  
  // Always add id as secondary sort for stable ordering
  return [{ [dbField]: sortDirection }, { id: sortDirection }];
}
